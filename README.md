...
### Hero Section
![Hero section — full-viewport dental clinic photo with headline and CTA buttons](screenshots/hero.png)

### Services Section
![Six dental service cards in a responsive grid](screenshots/services.png)

### About Section
![Two-column layout with doctor photo and biography](screenshots/about.png)

### Testimonials & Stats
![Patient review cards and blue stats bar](screenshots/testimonials.png)

### Gallery
![Mosaic photo grid of clinic interiors and patient results](screenshots/gallery.png)

### Contact & Footer
![Appointment booking form alongside contact details, and a dark footer](screenshots/contact.png)

> **Note:** Add your own screenshots to a `/screenshots` folder before publishing.
